...
running  "Hide language menu in the top right corner of the boot screen"
sudo defaults write /Library/Preferences/com.apple.loginwindow showInputMenu -bool false;ok

running "Set the timezone; see `sudo systemsetup -listtimezones` for other values"
sudo systemsetup -settimezone "Europe/Madrid" > /dev/null;ok
...
running "Show Dock in left position"
